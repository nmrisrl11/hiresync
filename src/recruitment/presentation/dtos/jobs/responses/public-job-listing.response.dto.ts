...
export class PublicJobListingResponseDto {
	@ApiProperty() public readonly id!: string;
	@ApiProperty() public readonly employerId!: string;
	@ApiProperty() public readonly companyName!: string;
	@ApiProperty({ nullable: true }) public readonly companyLogoUrl!: string | null;
	...
	@ApiProperty() public readonly postedAt!: Date;
}
